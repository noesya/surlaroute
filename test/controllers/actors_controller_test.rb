...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference("Actor.count") do
      post actors_url, params: { actor: { description: @actor.description, name: @actor.name, region_id: @actor.region_id, slug: @actor.slug } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { description: @actor.description, name: @actor.name, region_id: @actor.region_id, slug: @actor.slug } }
